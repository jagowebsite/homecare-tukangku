    ...
    <div class="br-pagebody">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button data-toggle="modal" data-target="#editRole" class="btn btn-secondary active"><i
                                            class="fa fa-edit"></i></button>
                                    <button data-toggle="modal" data-target="#AddPermissionToRole"
                                        class="btn btn-secondary active"><i class="fa fa-cog"></i></button>
        ...
        <div class="br-section-wrapper mt-3">
            ...
            <button data-toggle="modal" data-target="#AddPermission" class="btn btn-primary mb-4"><i
                    class="fa fa-plus"></i> Tambah Akses</button>
