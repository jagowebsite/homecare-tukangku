@extends('layouts.main', [
  'title' => 'Tambah Rekening - Tukangku',
  'menu' => 'master',
  'submenu' => 'rekening'
])
...
@section('content')
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Tambah Rekening</span>
        </nav>
    </div><!-- br-pageheader -->
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Tambah Rekening</h4>
        <p class="mg-b-0">Tambah data Rekening</p>
    </div>

    <div class="br-pagebody">
        <div class="br-section-wrapper">
            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Tambah Rekening</h6>
            <p class="mg-b-25 mg-lg-b-50">Tambah Rekening Owner homecare - Tukangku.</p>

            <form action="{{ route('account_store') }}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="row">
